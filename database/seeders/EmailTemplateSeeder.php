...
class EmailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            ['audience' => 'subscriber', 'template_key' => 'payment_reminder', 'template_name' => 'Payment Reminder', 'subject' => 'Payment Reminder', 'body' => '<p>Hello {{name}},</p><p>This is your payment reminder.</p>'],
