...
class EmailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            ['audience' => 'subscriber', 'template_key' => 'payment_reminder', 'template_name' => 'Payment Reminder', 'subject' => 'Outstanding Payment Reminder - {{client_name}} (Invoice {{invoice_no}})', 'body' => '<p>Outstanding Payment Reminder</p><p>=========================</p><p>Dear {{client_name}},</p><p>You have an outstanding to pay.</p><p>Application/Service :- {{application_service}}<br>Outstanding Amount :- {{currency_symbol}} {{outstanding_amount}}</p><p>Due Date :- {{due_date}}<br>Payment Link :- {{payment_link}}</p><p>Clear the outstanding to avoid interruptions in services.</p><p>Regards,<br>{{subscriber_name}}</p>'],
